<?php
    ...
    echo '<h1> Analista - '. $login_analyst . '</h1>';
    echo '</div>';
	...
	echo form_open('analysts/view/'.$id, $attributes);
    ...
    if ( $active_search === 0  )
    {
    	...
    	$fields = array( 'ev.glpi' => 'GLPI', 'en.name' => 'Ambiente', 'ac.name' => 'Schema', 'ev.sequence_id' => 'Sequencia', 'sc.script' => 'Script', 'sc.version' => 'Versão', 'anD.name' => 'Dba/Ad',
