<?php
	...
	echo form_open('evolutions/index',$attributes);
    ...
    if ( $active_search === 0  )
    {
    	...
    	$fields = array( 'ev.glpi' => 'GLPI', 'en.name' => 'Ambiente', 'ac.name' => 'Schema', 'ev.sequence_id' => 'Sequencia', 'sc.script' => 'Script', 'sc.version' => 'Versão', 'an.login' => 'Analista', 'anD.name' => 'Dba/Ad',
