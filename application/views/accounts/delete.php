<?php
    ...
    echo '<p><h2><span class=aviso_vermelho>'. $count . '</span> registros serão removidos se o schema <span class=aviso_vermelho>' . $name . '</span> for removido.</h2></p>';
    ...
    echo form_open('accounts/delete/'.$id);
