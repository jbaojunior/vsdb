<?php
	...
	echo form_open('accounts/view/'.$id, $attributes);
    ...
    if ( $active_search === 0  )
    {
    	...
    	$fields = array( 'ev.glpi' => 'GLPI', 'en.name' => 'Ambiente', 'ev.sequence_id' => 'Sequencia', 'sc.script' => 'Script', 'sc.version' => 'Versão', 'an.login' => 'Analista', 'anD.name' => 'Dba/Ad',
